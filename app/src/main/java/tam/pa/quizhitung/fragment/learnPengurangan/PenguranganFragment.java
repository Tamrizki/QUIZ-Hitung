package tam.pa.quizhitung.fragment.learnPengurangan;
...
public class PenguranganFragment extends Fragment {
    LearnItem dataMateri;
    public PenguranganFragment(LearnItem learnItem) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pengurangan, container, false);
