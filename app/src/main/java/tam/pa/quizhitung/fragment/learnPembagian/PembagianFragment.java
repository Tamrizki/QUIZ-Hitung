package tam.pa.quizhitung.fragment.learnPembagian;
...
public class PembagianFragment extends Fragment {
    LearnItem dataMateri;
    public PembagianFragment(LearnItem learnItem) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pembagian, container, false);
